...
# If M1 >= N, then subtract N from M1 and call the difference
# M2. Keep doing this operation until you reach a value k,
# such that, Mk < N. You have to print the value of Mk as output.
# You should be able to solve this problem using the
